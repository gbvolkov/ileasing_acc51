...
#Номер строки|Дата проводки|Вид операции|Дата документа|Номер документа|Счет плательщика/получателя|Реквизиты плательщика/получателя денежных средств.Наименование/ФИО|Реквизиты плательщика/получателя денежных средств.ИНН/КИО|Реквизиты плательщика/получателя денежных средств.КПП|Сумма Дебет|Сумма Кредит|Назначение платежа
#номерстроки|датапроводки|видоперации|датадокумента|номердокумента|счетплательщика/получателя|реквизитыплательщика/получателяденежныхсредств.наименование/фио|реквизитыплательщика/получателяденежныхсредств.инн/кио|реквизитыплательщика/получателяденежныхсредств.кпп|суммадебет|суммакредит|назначениеплатежа
#номерстроки|датапроводки|видоперации|номердокумента|счетплательщика/получателя|реквизитыплательщика/получателяденежныхсредств.наименование/фио|реквизитыплательщика/получателяденежныхсредств.инн/кио|реквизитыплательщика/получателяденежныхсредств.кпп|суммадебет|суммакредит|назначениеплатежа
...
def BankStatement_23_process(header: pd.DataFrame, data: pd.DataFrame, footer: pd.DataFrame, inname: str, clientid: str, sheet: str, logf: TextIOWrapper) -> pd.DataFrame:
    ...
    if "реквизитыплательщика/получателяденежныхсредств.инн/кио" in data.columns:
        df["cpTaxCode"] = data["реквизитыплательщика/получателяденежныхсредств.инн/кио"]
    if "реквизитыплательщика/получателяденежныхсредств.наименование/фио" in data.columns:
        df["cpName"] = data["реквизитыплательщика/получателяденежныхсредств.наименование/фио"]
