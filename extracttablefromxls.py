...
HDRSIGNATURES = [{"Дата документа|Дата операции|№|БИК|Счет|Контрагент|ИНН контрагента|БИК банка контрагента|Корр.счет банка контрагента|Наименование банка контрагента|Счет контрагента|Списание|Зачисление|Назначение платежа|Код": BankStatement_1_process},
                 ...
                 {"Дата операции|Номер документа|Дебет|Кредит|Контрагент.Наименование|Контрагент.ИНН|Контрагент.КПП|Контрагент.БИК|Контрагент.Наименованиебанка|Назначение платежа|Код дебитора|Тип документа": BankStatement_3_process},
                 ...
                 {"Дата операции|Номер документа|Дебет|Кредит|Контрагент.Наименование|Контрагент.ИНН|Контрагент.КПП|Контрагент.Счет|Контрагент.БИК|Контрагент.Наименованиебанка|Назначение платежа|Код дебитора|Тип документа": BankStatement_3_process},
                 ...
                 {"№ док|Дата документа|Дата операции|Реквизиты корреспондента.Наименование|Реквизиты корреспондента.Счет|Реквизиты корреспондента.ИННКонтрагента|Реквизиты корреспондента.Банк|Дебет Сумма/Сумма в НП|Кредит Сумма/Сумма в НП|Курс ЦБ на дату операции|Основание операции (назначение платежа)": BankStatement_4_process},
                 ...
                 {"Дата|Номер документа|Дебет|Кредит|Контрагент.Наименование|Контрагент.ИНН|Контрагент.КПП|Контрагент.БИК|Контрагент.Наименованиебанка|Назначение платежа|Тип документа": BankStatement_5_process},
                 ...
                 {"Дата|Номер документа|Дебет|Кредит|Контрагент.Наименование|Контрагент.ИНН|Контрагент.КПП|Контрагент.БИК|Контрагент.Наименованиебанка|Назначение платежа|Код дебитора|Тип документа": BankStatement_5_process},
                 ...
                 {"Дата|Номер документа|Дебет|Кредит|Контрагент.Наименование|Контрагент.ИНН|Контрагент.КПП|Контрагент.Счет|Контрагент.БИК|Контрагент.Наименованиебанка|Назначение платежа|Код дебитора|Тип документа": BankStatement_5_process},
                 ...
                 {"Дата|Номер документа|Дебет|Кредит|Контрагент.Наименование|Контрагент.ИНН|Контрагент.КПП|Контрагент.Счёт|Контрагент.БИК|Контрагент.Наименованиебанка|Назначение платежа|Код дебитора|Тип документа": BankStatement_5_process},                 
                 ...
                 {"Дата опер.|КО|Номер докум.|Дата докум.|Дебет|Кредит|Рублевое покрытие|Контрагент.ИНН|Контрагент.КПП|Контрагент.Наименование|Контрагент.Счет|Контрагент.БИК|Контрагент.Коррсчет|Контрагент.Банк|Клиент.ИНН|Клиент.Наименование|Клиент.Счет|Клиент.КПП|Клиент.БИК|Клиент.Коррсчет|Клиент.Банк|Код|Назначение платежа|Очер. платежа|Бюджетный платеж.Статуссост.|Бюджетный платеж.КБК|Бюджетный платеж.ОКТМО|Бюджетный платеж.Основание|Бюджетный платеж.Налог.период|Бюджетный платеж.Номердок.|ID опер.": BankStatement_8_process},
                 ...
                 {"Дата опер.|КО|Номер докум.|Дата докум.|Дебет|Кредит|Рублевое покрытие|Контрагент.ИНН|Контрагент.КПП|Контрагент.Наименование|Контрагент.Счет|Контрагент.БИК|Контрагент.Коррсчет|Контрагент.Банк|Клиент.ИНН|Клиент.Наименование|Клиент.Счет|Клиент.КПП|Клиент.БИК|Клиент.Коррсчет|Клиент.Банк|Рез. Поле|Код|Код выплат|Назначение платежа|Очер. платежа|Вид условия оплаты|Основание для списания|Бюджетный платеж.Статуссост.|Бюджетный платеж.КБК|Бюджетный платеж.ОКТМО|Бюджетный платеж.Основание|Бюджетный платеж.Налог.период|Бюджетный платеж.Номердок.|Бюджетный платеж.Датадок.|ID опер.": BankStatement_8_process},
                 ...
                 {"Дата опер.|КО|Номер докум.|Дата докум.|Дебет|Кредит|Рублевое покрытие|Контрагент.ИНН|Контрагент.КПП|Контрагент.Наименование|Контрагент.Счет|Контрагент.БИК|Контрагент.Коррсчет|Контрагент.Банк|Клиент.ИНН|Клиент.Наименование|Клиент.Счет|Клиент.КПП|Клиент.БИК|Клиент.Коррсчет|Клиент.Банк|Рез. Поле|Код|Код выплат|Назначение платежа|Очер. платежа|Вид условия оплаты|Основание для списания|Бюджетный платеж.Статуссост.|Бюджетный платеж.КБК|Бюджетный платеж.ОКТМО|Бюджетный платеж.Основание|Бюджетный платеж.Налог.период|Бюджетный платеж.Номердок.|Бюджетный платеж.Датадок.|ID опер.|ID докум.": BankStatement_8_process},
                 {"Дата опер.|КО|Номер докум.|Дата докум.|Дебет|Кредит|Рублевое покрытие|Контрагент.ИНН|Контрагент.КПП|Контрагент.Наименование|Контрагент.Счет|Контрагент.БИК|Контрагент.Коррсчет|Контрагент.Банк|Клиент.ИНН|Клиент.Наименование|Клиент.Счет|Клиент.КПП|Клиент.БИК|Клиент.Коррсчет|Клиент.Банк|Рез. Поле|Код|Код выплат|Назначение платежа|Очер. платежа|Вид условия оплаты|Бюджетный платеж.Статуссост.|Бюджетный платеж.КБК|Бюджетный платеж.ОКТМО|Бюджетный платеж.Основание|Бюджетный платеж.Налог.период|Бюджетный платеж.Номердок.|Бюджетный платеж.Датадок.|ID опер.|ID докум.": BankStatement_8_process},
                 ...
                 {"Номер строки|Дата проводки|Вид операции|Номер документа клиента|Номер документа банка (Номер документа в СМФР)|Счет плательщика/получателя|Сумма Дебет|Сумма Кредит|Назначение платежа": BankStatement_27_process},
                 ...
                 #{"Дата операции|Номер документа|Дебет|Кредит|Контрагент.Наименование|Контрагент.ИНН|Контрагент.КПП|Контрагент.БИК|Контрагент.Наименование банка|Назначение платежа|Код дебитора|Тип документа": BankStatement_26_process},
                 {"Дата операции|Номер документа|Дебет|Кредит|Контрагент.Наименование|Контрагент.ИНН|Контрагент.КПП|Контрагент.БИК|Контрагент.Наименованиебанка|Назначение платежа|Код дебитора|Тип документа": BankStatement_26_process},
                 {"Дата и время проводки|Вход остаток|Дебет|Кредит|Исходящий остаток|Док.|Наименование корреспондента|ИНН корреспондента|Назначение платежа": BankStatement_28_process},
                 #{"№ п/п|Дата совершения операции (дд.мм.гг)|Реквизиты документа, на основании которого была совершена операция по счету (специальному банковскому счету).вид (шифр)|Реквизиты документа, на основании которого была совершена операция по счету (специальному банковскому счету).номер|Реквизиты документа, на основании которого была совершена операция по счету (специальному банковскому счету).дата|Реквизиты банка плательщика/получателя денежных средств.номер корреспондентского счета|Реквизиты банка плательщика/получателя денежных средств.наименование|Реквизиты банка плательщика/получателя денежных средств.БИК|Реквизиты плательщика/получателя денежных средств.наименование/Ф.И.О.|Реквизиты плательщика/получателя денежных средств.ИНН/КИО|Реквизиты плательщика/получателя денежных средств.КПП|Реквизиты плательщика/получателя денежных средств.номер счета |Сумма операции по счету .по дебету|Сумма операции по счету .по кредиту|Назначение платежа": BankStatement_29_process},
                 {"№ п/п|Дата совершения операции (дд.мм.гг)|Реквизиты документа, на основании которого была совершена операция по счету (специальному банковскому счету).вид(шифр)|Реквизиты документа, на основании которого была совершена операция по счету (специальному банковскому счету).номер|Реквизиты документа, на основании которого была совершена операция по счету (специальному банковскому счету).дата|Реквизиты банка плательщика/получателя денежных средств.номеркорреспондентскогосчета|Реквизиты банка плательщика/получателя денежных средств.наименование|Реквизиты банка плательщика/получателя денежных средств.БИК|Реквизиты плательщика/получателя денежных средств.наименование/Ф.И.О.|Реквизиты плательщика/получателя денежных средств.ИНН/КИО|Реквизиты плательщика/получателя денежных средств.КПП|Реквизиты плательщика/получателя денежных средств.номерсчета|Сумма операции по счету .подебету|Сумма операции по счету .покредиту|Назначение платежа": BankStatement_29_process},
                 {"Номер строки|Дата проводки|Вид операции|Номер документа клиента|Номер документа банка (Номер документа в СМФР)|Счет плательщика/получателя|Наименование корреспондирующего счета|Сумма Дебет|Сумма Кредит|Назначение платежа": BankStatement_27_process},
                 {"Дата проводки|ВО|N док|Банк корр.|Корреспондент|Счет контрагента|Дебет|Кредит|Назначение платежа": BankStatement_30_process},
                 {"Документ|Дата операции|Корреспондент.Наименование|Корреспондент.ИНН|Корреспондент.Счет|Корреспондент.БИК|Вх.остаток|Оборот Дт|Оборот Кт|Назначение платежа": BankStatement_31_process},
                 {"Дата|№ док.|ВО|БИК банка контрагента|Банк контрагента|ИНН контрагента|Контрагент|Счет контрагента|Дебет|Кредит|Назначение платежа": BankStatement_32_process},
                 {"Дата документа|Номер документа|Поступление|Списание|Счёт организации|Организация|ИНН организации|Счёт контрагента|Контрагент|ИНН контрагента|Назначение платежа|Код дебитора|Тип документа": BankStatement_33_process},
                 {"Дата документа|Номер документа|Счёт организации|Организация|ИНН организации|Счёт контрагента|Контрагент|ИНН контрагента|Назначение платежа|Поступление|Списание|Остаток входящий|Остаток исходящий|Код дебитора|Тип документа": BankStatement_33_process},
                 {"Дата док-та|Номер док-та|Корреспондент.Банк|Корреспондент.Счет|Корреспондент.Наименование|Вид опер.|Обороты.подебету|Обороты.покредиту|Назначение платежа": BankStatement_34_process},
                 {"Дата док-та|Номер док-та|Корреспондент.Банк|Корреспондент.Счет|Корреспондент.Наименование|Вид опер.|Обороты.по дебету|Обороты.по кредиту|Назначение платежа": BankStatement_34_process},
                 {"Номер строки|Дата проводки|Вид операции|Дата документа|Номер документа|Счет плательщика/получателя|Реквизиты плательщика/получателя денежных средств.Наименование/ФИО|Реквизиты плательщика/получателя денежных средств.ИНН/КИО|Реквизиты плательщика/получателя денежных средств.КПП|Сумма Дебет|Сумма Кредит|Назначение платежа": BankStatement_23_process},
                 {"Дата|№ док.|ВО|Название корр.|БИК банка корр.|Лицевой счет|Дебет|Кредит|Назначение": BankStatement_22_process},
                 {"Дата проводки|№ документа|Клиент.ИНН|Клиент.Наименование|Клиент.Счет|Корреспондент.БИК|Корреспондент.Банк|Корреспондент.Счет|Корреспондент.ИНН|Корреспондент.Наименование|В О|Назначение платежа|Обороты.Дебет|Обороты.Кредит|Референс проводки": BankStatement_35_process},
                 {"Номер счета|Идентификатор транзакции|Тип операции (пополнение/списание)|Категория операции|Статус|Дата создания операции|Дата авторизации|Дата транзакции|Идентификатор оригинальной операции|Сумма операции в валюте операции|Валюта операции|Сумма в валюте счета|Контрагент|ИНН контрагента|КПП контрагента|Счет контрагента|БИК банка контрагента|Корр. счет банка контрагента|Наименование банка контрагента|Назначение платежа|Номер платежа|Очередность|Код (УИН)|Номер карты|MCC|Место совершения (Город)|Место совершения (Страна)|Адрес организации|Банк|Статус составителя расчетного документа|КБК-код бюджетной классификации|Код ОКТМО|Основание налогового платежа|Налоговый период/Код таможенного органа|Номер налогового документа|Дата налогового документа|Тип налогового платежа": BankStatement_36_process},
                 ]
